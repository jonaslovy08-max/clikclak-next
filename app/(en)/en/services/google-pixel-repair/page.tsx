...
export const metadata: Metadata = {
  title: 'Google Pixel Repair Lausanne — ClikClak',
...
export default function EnGooglePixelRepairPage() {
  return (
    <>
      <Header locale="en" />
      <main>
        <section className="px-6 md:px-14 lg:px-20 py-16 border-t border-white/10">
          <div className="w-full max-w-6xl mx-auto flex flex-col gap-8">
            ...
            <p className="font-light" style={{ color: 'rgba(242,242,242,0.65)', fontSize: 'clamp(15px, 1.5vw, 19px)' }}>
              Pricing data for Google Pixel is not yet available. Contact us for a diagnostic and quote.
            </p>
