...
const BASE_HREF = '/en/services/sony-xperia-repair'
...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        'fr-CH': `${SITE_URL}/services/reparation-sony-xperia/${model.id}`,
        'en-CH': `${SITE_URL}${BASE_HREF}/${model.id}`,
        'x-default': `${SITE_URL}/services/reparation-sony-xperia/${model.id}`,
      },
    },
    openGraph: {
