...
const BASE_HREF = '/services/reparation-ipad'
...
export async function generateMetadata({
  ...
  return {
    ...
    description: `Consultez les prix de réparation ${model.label} à Lausanne : écran, vitre, batterie, connecteur de charge et diagnostic chez ClikClak.`,
    alternates: {
      canonical: `${SITE_URL}${BASE_HREF}/${modelSlug}`,
      languages: {
        'fr-CH':     `${SITE_URL}${BASE_HREF}/${modelSlug}`,
        'en-CH':     `${SITE_URL}/en/services/ipad-repair/${modelSlug}`,
        'x-default': `${SITE_URL}${BASE_HREF}/${modelSlug}`,
      },
    },
    openGraph: {
      title:       `Réparation ${model.label} Lausanne — ClikClak`,
      description: `Prix de réparation ${model.label} à Lausanne. Écran, vitre, batterie et plus. Pièces de qualité, garantie incluse.`,
